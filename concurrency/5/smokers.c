...
(the book provided with the assignment)
*/
...
void *agent_func(void *arg){
    ...
    while(1){
        ...
        sem_wait(&agent_sem);
        if(agent_num == 1){
            printf("Agent %d is providing tobacco and paper\n", agent_num);
            sem_post(&tobacco);
            sem_post(&paper);
        }
        else if(agent_num == 2){
            printf("Agent %d is providing paper and matches\n", agent_num);
            sem_post(&paper);
            sem_post(&match);
        }
        else if(agent_num == 3){
            printf("Agent %d is providing tobacco and matches\n", agent_num);
            sem_post(&tobacco);
            sem_post(&match);
        }
        else{
            printf("*** Agent random num error ***\n");
        }
    }
}
...
void *tobacco_smoke(void *arg){
    int num = 1;
    printf("Tobacco smoker num is: %d\n", num);
    while(1){
